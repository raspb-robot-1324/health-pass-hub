import { u as useRouter, j as jsxRuntimeExports, a as compileDecodeCharMap, b as createLRUCache, t as trimPath, r as rewriteBasepath, d as composeRewrites, p as processRouteTree, e as processRouteMasks, f as resolvePath, g as cleanPath, h as trimPathRight, i as createControlledPromise, k as parseHref, l as executeRewriteInput, m as isDangerousProtocol, n as redirect, o as isRedirect, q as isNotFound, s as findSingleMatch, v as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, w as interpolatePath, x as nullReplaceEqualDeep, y as replaceEqualDeep, z as last, A as decodePath, B as findFlatMatch, C as functionalUpdate, E as findRouteMatch, F as isPromise, G as invariant, H as rootRouteId, I as executeRewriteOutput, J as arraysEqual, R as React, K as reactExports, L as dummyMatchContext, M as matchContext, N as isModuleNotFoundError, O as isServer, P as trimPathLeft, Q as joinPaths, S as exactPathTest, U as removeTrailingSlash, V as encodePathLikeUrl, W as requireReactDom, X as Outlet, Y as escapeHtml, Z as getAssetCrossOrigin, _ as useHydrated, $ as resolveManifestAssetLink, a0 as getDefaultExportFromCjs } from "./index.mjs";
import "node:events";
...
function createRouterStores(initialState2, config3) {
  const { createMutableStore, createReadonlyStore, batch, init: init4 } = config3;
...
var buildMatchContext = (inner, index, includeCurrentMatch = true) => {
  const context3 = { ...inner.router.options.context ?? {} };
  ...
  for (let i = 0; i <= end; i++) {
    ...
    if (!m) continue;
    Object.assign(context3, m.__routeContext, m.__beforeLoadContext);
  }
  return context3;
};
...
var getLoaderContext = (inner, matchPromises, matchId, index, route) => {
  ...
  const context3 = buildMatchContext(inner, index);
  const preload = resolvePreload(inner, matchId);
  return {
    params,
    deps: loaderDeps,
  ...
  constructor(options, getStoreConfig) {
    ...
    this.update = (newOptions) => {
      ...
      if (!this.stores && this.latestLocation) {
        const config3 = this.getStoreConfig(this);
        this.batch = config3.batch;
        this.stores = createRouterStores(getInitialRouterState(this.latestLocation), config3);
      }
...
function buildMiddlewareChain(destRoutes) {
  ...
  for (const route of destRoutes) {
    if ("search" in route.options) {
      if (route.options.search?.middlewares) context3.middlewares.push(...route.options.search.middlewares);
      ...
      context3.middlewares.push(legacyMiddleware);
    }
    if (route.options.validateSearch) {
      const validate = ({ search, next }) => {
        const result = next(search);
        if (!context3._includeValidateSearch) return result;
        try {
          return {
            ...result,
      ...
      context3.middlewares.push(validate);
    }
  }
  const final = ({ search }) => {
    const dest = context3.dest;
    if (!dest.search) return {};
    if (dest.search === true) return search;
    return functionalUpdate(dest.search, search);
  };
  context3.middlewares.push(final);
  ...
  return function middleware(search, dest, _includeValidateSearch) {
    context3.dest = dest;
    context3._includeValidateSearch = _includeValidateSearch;
    return applyNext(0, search, context3.middlewares);
  };
}
...
const useTheme = () => {
  const context3 = reactExports.useContext(ThemeProviderContext);
  if (context3 === void 0)
...
function keysFromSelector(selector3, opts) {
  const {
    [PATH_KEY]: path
  } = selector3(createProxy());
...
const appCss = "/assets/styles-DgahD6DP.css";
...
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Novera Health" },
      { property: "og:title", content: "Novera" },
      { property: "og:description", content: "A medical OS for Quebec: live dashboard, emergency passport, secure QR key, and AI guidance." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@NoveraHealth" }
    ],
    links: [
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { defaultTheme: "dark", storageKey: "novera-theme", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const $$splitComponentImporter$6 = () => import("./qr-DTv1OwlF.mjs");
const Route$6 = createFileRoute("/qr")({
  head: () => ({
    meta: [{
      title: "QR Key — Novera"
    }, {
      name: "description",
      content: "Generate a secure, revocable QR key."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./passport-BudnVfqc.mjs");
const Route$5 = createFileRoute("/passport")({
  head: () => ({
    meta: [{
      title: "Emergency Passport — Novera"
    }, {
      name: "description",
      content: "Critical medical info for first responders."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./onboarding-CWHTRgxb.mjs");
const Route$4 = createFileRoute("/onboarding")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-DpHqYtzp.mjs");
const Route$3 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your medical dashboard."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./auth-BVEQCsj0.mjs");
const Route$2 = createFileRoute("/auth")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Create your Novera account or sign in."
    }]
  }),
...
}, _callback2 = function _callback3(self2, func, extraParam) {
  if (self2.enabled) {
    var result = self2._ctx ? self2._ctx.add(function() {
      return func(self2, extraParam);
    }) : func(self2, extraParam);
          ...
          if (scroll <= end && scroll >= start && endScroll !== scroll) {
            ...
            tweenTo(endScroll, {
              ...
              onInterrupt: function onInterrupt() {
                return snapDelayedCall.restart(true) && _onInterrupt && _callback2(self2, _onInterrupt);
              },
              onComplete: function onComplete() {
                self2.update();
                lastSnap = scrollFunc();
                ...
                _onComplete && _callback2(self2, _onComplete);
              }
            }, scroll, change1 * change, endScroll - scroll - change1 * change);
            onStart && _callback2(self2, onStart, tweenTo.tween);
          }
...
const $$splitComponentImporter$1 = () => import("./index-plqTFIhS.mjs");
...
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A medical OS for Quebec: live dashboard, emergency passport, secure QR key, and AI guidance."
    }, {
      property: "og:title",
      content: "Novera"
    }, {
      property: "og:description",
      content: "Medical dashboard, emergency passport, secure QR key."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./p._id-D3Ri7mXA.mjs");
const Route2 = createFileRoute("/p/$id")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const QrRoute = Route$6.update({
  id: "/qr",
  path: "/qr",
  getParentRoute: () => Route$7
});
const PassportRoute = Route$5.update({
  id: "/passport",
  path: "/passport",
  getParentRoute: () => Route$7
});
